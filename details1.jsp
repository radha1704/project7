...
-->
	<div class="well well-small">
	<h3>New Products </h3>
<form name="kjhggd" method="Post" action="login1.jsp">
...
l1=document.getElementById("l");
r1=document.getElementById("r");
u1.type="text";
u1.placeholder="Username";
p1.type="text";
p1.placeholder="Password";
l1.type="submit";
l1.value="Login";
r1.type="button";
r1.value="Register";
...
<table>
<tr>
<td rowspan="7"><img src='<%=rs.getString(6)%>'></td>
<td>PRODUCT ID:</td><td><%=rs.getString(1) %></td></tr>
<td>PRICE:</td><td><%=rs.getString(3) %></td></tr><br>
<td>MFG.COMPANY NAME:</td><td><%=rs.getString(4) %></td></tr>
<tr><td>DESCPRITION:</td><td><%=rs.getString(5) %></td></tr><br>
</td></tr>


</table>
<input type="button" value="BUY NOW" onclick="a()">
<input type="hidden" id="u" name="u">
<input type="hidden" id="p" name="p">
<input type="hidden" id="l">
<a href="register.jsp"><input type="hidden" id="r"></a>
