...
<table>
<tr>
<td rowspan="6"><img src='<%=rs.getString(6)%>'></td>
<td>PRODUCT ID :</td><td><input type="text" name="u1" value="<%=rs.getString(1) %>"></td></tr><br>
<tr><td>PRODUCT NAME :</td><td><input type="text" name="u2" value="<%=rs.getString(2) %>"></td></tr><br>
...
%>
<a href="buy.jsp" target ="f2"><input type="submit" value="BUy now"></a>
</div>
