...
pst=conn.prepareStatement("select * from cart where username=? and password=?");
...
<td><img src='<%=rs.getString(6)%>' height="150" width="180"><br>
<br>product id:<%=rs.getString(1)%>
<br>product name:<%=rs.getString(2)%>
<br>price:<% s=s+rs.getInt(3);out.println(rs.getInt(3));%>


<br>mfg.company:<%=rs.getString(4)%>
<br>details:<%=rs.getString(5)%><br>

<a href="remove.jsp?id=<%=rs.getString(1)%>"><input type="submit" value="Remove"></a></td></tr>

<%
}
session.setAttribute("ke",s);
out.println("TOTAL:"+s);
conn.close();
pst.close();
}
...
%>
<center><a href="home2.jsp"><input type="button" value="Add"></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="trans.jsp"><input type="button" value="Done"></a></center>
